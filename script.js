...
document.addEventListener('DOMContentLoaded', () => {
    const thaiButton = document.getElementById('thai-btn');
    const englishButton = document.getElementById('english-btn');

    thaiButton.addEventListener('click', () => {
        document.documentElement.lang = 'th';
        // Additional logic for switching content to Thai
    });

    englishButton.addEventListener('click', () => {
        document.documentElement.lang = 'en';
        // Additional logic for switching content to English
    });
});
